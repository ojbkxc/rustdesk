...
def build_flutter_dmg(version, features):
    ...
    # xcode names the bundle from PRODUCT_NAME (AppInfo.xcconfig), so follow it here.
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/AIRX.app/Contents/MacOS/')
    '''
    system2(
